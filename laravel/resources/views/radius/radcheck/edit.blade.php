                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="username" type="text" class="form-control form-control-sm"
                                           name="username"
                                           value="{{ $radcheck->username }}" required autocomplete="username" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="attribute" type="text" class="form-control form-control-sm"
                                           name="attribute"
                                           value="{{ $radcheck->attribute }}" required autocomplete="attribute"
                                           autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="op" type="text" class="form-control form-control-sm" name="op"
                                           value="{{ $radcheck->op }}" required autocomplete="op" autofocus>
                                </div>
                            </div>
