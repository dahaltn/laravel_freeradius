...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><h3>{{ __('Edit Group check') }}</h3></div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form method="POST" action="{{ route('radgroupcheck.update', $radgroupcheck->id) }}">
                            @csrf
                            @method('PATCH')
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="groupname" type="text" class="form-control form-control-sm"
                                           name="groupname"
                                           value="{{ $radgroupcheck->groupname }}" required autocomplete="groupname" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="attribute" type="text" class="form-control form-control-sm"
                                           name="attribute"
                                           value="{{ $radgroupcheck->attribute }}" required autocomplete="attribute"
                                           autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="op" type="text" class="form-control form-control-sm" name="op"
                                           value="{{ $radgroupcheck->op }}" required autocomplete="op" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="value" type="text" class="form-control form-control-sm" name="value"
                                           value="{{ $radgroupcheck->value }}" required autocomplete="value" autofocus>
                                </div>
                            </div>
