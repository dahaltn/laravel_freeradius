                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('customers.update', $customer->id) }}" method="POST">
                            ...
                            <div class="border mb-5">
                                ...
                                <div class="form-group row">
                                    <label for="balance"
                                           class="col-md-4 col-form-label text-md-right"><strong>{{ __('Balance amount') }}
                                            :</strong></label>
                                    <div class="col-md-6">
                                        <input id="balance" type="text" class="form-control form-control-sm"
                                               name="balance" value="{{ $customer->amount() }}" disabled>
                                    </div>
                                </div>
                            </div>
